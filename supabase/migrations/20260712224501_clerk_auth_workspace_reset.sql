-- Fresh reset from Supabase Auth/custom workspaces to Clerk Auth + Clerk Organizations.
-- Clerk is the source of user identity, organization membership, and organization roles.
...
drop policy if exists "new_hires_select" on public.new_hires;
drop policy if exists "new_hires_insert" on public.new_hires;
drop policy if exists "new_hires_update" on public.new_hires;
drop policy if exists "new_hires_delete" on public.new_hires;
...
drop policy if exists "ramp_milestones_insert" on public.ramp_milestones;
drop policy if exists "ramp_milestones_update" on public.ramp_milestones;
drop policy if exists "ramp_milestones_delete" on public.ramp_milestones;
create policy "ramp_milestones_select" on public.ramp_milestones
  for select to authenticated using (organization_id is null or private.is_organization_member(organization_id));
...
drop policy if exists "ramp_deliveries_select" on public.ramp_deliveries;
drop policy if exists "ramp_deliveries_insert" on public.ramp_deliveries;
drop policy if exists "ramp_deliveries_update" on public.ramp_deliveries;
drop policy if exists "ramp_deliveries_delete" on public.ramp_deliveries;
...
drop policy if exists "readiness_items_select" on public.readiness_items;
drop policy if exists "readiness_items_insert" on public.readiness_items;
drop policy if exists "readiness_items_update" on public.readiness_items;
drop policy if exists "readiness_items_delete" on public.readiness_items;
...
drop policy if exists "role_profiles_insert" on public.role_profiles;
drop policy if exists "role_profiles_update" on public.role_profiles;
drop policy if exists "role_profiles_delete" on public.role_profiles;
...
drop policy if exists "org_tools_insert" on public.org_tools;
drop policy if exists "org_tools_update" on public.org_tools;
drop policy if exists "org_tools_delete" on public.org_tools;
...
drop policy if exists "readiness_delivery_settings_select" on public.readiness_delivery_settings;
drop policy if exists "readiness_delivery_settings_insert" on public.readiness_delivery_settings;
drop policy if exists "readiness_delivery_settings_update" on public.readiness_delivery_settings;
drop policy if exists "readiness_delivery_settings_delete" on public.readiness_delivery_settings;
...
drop policy if exists "milestone_generation_runs_select" on public.milestone_generation_runs;
drop policy if exists "milestone_generation_runs_insert" on public.milestone_generation_runs;
drop policy if exists "milestone_generation_runs_update" on public.milestone_generation_runs;
drop policy if exists "milestone_generation_runs_delete" on public.milestone_generation_runs;
...
drop policy if exists "milestone_proposals_select" on public.milestone_proposals;
drop policy if exists "milestone_proposals_insert" on public.milestone_proposals;
drop policy if exists "milestone_proposals_update" on public.milestone_proposals;
drop policy if exists "milestone_proposals_delete" on public.milestone_proposals;
...
drop policy if exists "new_hire_milestone_progress_select" on public.new_hire_milestone_progress;
drop policy if exists "new_hire_milestone_progress_insert" on public.new_hire_milestone_progress;
drop policy if exists "new_hire_milestone_progress_update" on public.new_hire_milestone_progress;
drop policy if exists "new_hire_milestone_progress_delete" on public.new_hire_milestone_progress;
...
drop policy if exists "milestone_evidence_select" on public.milestone_evidence;
drop policy if exists "milestone_evidence_insert" on public.milestone_evidence;
drop policy if exists "milestone_evidence_update" on public.milestone_evidence;
drop policy if exists "milestone_evidence_delete" on public.milestone_evidence;
...
drop policy if exists "onboarding_notifications_select" on public.onboarding_notifications;
drop policy if exists "onboarding_notifications_insert" on public.onboarding_notifications;
drop policy if exists "onboarding_notifications_update" on public.onboarding_notifications;
drop policy if exists "onboarding_notifications_delete" on public.onboarding_notifications;
...
create policy "oauth_connections_user_all" on public.oauth_connections
  for all to authenticated using (user_id = private.clerk_user_id()) with check (user_id = private.clerk_user_id());
create policy "oauth_provider_tokens_user_all" on public.oauth_provider_tokens
  for all to authenticated using (user_id = private.clerk_user_id()) with check (user_id = private.clerk_user_id());
