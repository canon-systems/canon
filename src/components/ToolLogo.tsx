...
// Salesforce cloud icon path from the Simple Icons project.
...
const TOOL_MAP: Record<string, ToolConfig> = {
  ...
  github: {
    bg: '#f0f0f0',
    fg: '#181717',
    render: (size) => <BrandIcon name="github" size={size} color="#181717" />,
  },
  zoom: {
    bg: '#e6f0ff',
    fg: '#2D8CFF',
    render: (size) => <BrandIcon name="zoom" size={size} color="#2D8CFF" />,
  },
  outreach: {
    bg: '#eeeeff',
    fg: '#5957E5',
