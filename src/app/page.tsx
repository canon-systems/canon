...
const operatingLoop = [
  ...
  },
  {
    ...
    description: 'See whether each person is learning the right work and proving it in real customer moments.',
  ...
  },
  {
    ...
    description: 'Find product, customer, and team changes that people need to know about now.',
...
const setupFocus = [
  ...
  },
  {
    ...
    description: 'Connect the apps Canon should learn from so team guidance stays current.',
